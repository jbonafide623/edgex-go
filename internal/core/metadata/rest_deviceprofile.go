...
func restAddDeviceProfile(w http.ResponseWriter, r *http.Request) {
	...
	if Configuration.Writable.EnableValueDescriptorManagement {
		...
		err = op.Execute()
		if err != nil {
			HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileServiceClientErrorConcept{Err: err}}, httperror.StatusInternalServerErrorConcept{})
			return
		}
	}
...
func restUpdateDeviceProfile(w http.ResponseWriter, r *http.Request) {
	...
	if Configuration.Writable.EnableValueDescriptorManagement {
		...
		err := vdOp.Execute()
		if err != nil {
			HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileServiceClientErrorConcept{Err: err}, httperror.DeviceProfileNotFoundErrorConcept{}, httperror.ValueDescriptorsInUseErrorConcept{}, httperror.DeviceProfileInvalidStateErrorConcept{}}, httperror.StatusInternalServerErrorConcept{})
			return
		}
	}
	...
	dp, err := op.Execute()
	if err != nil {
		HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileNotFoundErrorConcept{}, httperror.DeviceProfileInvalidStateErrorConcept{}}, httperror.StatusInternalServerErrorConcept{})
		return
	}
...
func restAddProfileByYaml(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileMissingFileErrorConcept{}}, httperror.StatusInternalServerErrorConcept{})
		return
	}
	...
	if len(data) == 0 {
		HttpErrorHandler.Handle(w, errors.NewErrEmptyFile("YAML"), []httperror.ErrorConceptType{}, httperror.StatusBadRequestErrorConcept{})
		return
	}
	...
	if err != nil {
		HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileBadRequestErrorConcept{}, httperror.DeviceProfileContractInvalidErrorConcept{}, httperror.DuplicateIdentifierErrorConcept{}, httperror.DeviceProfileEmptyNameErrorConcept{}}, httperror.StatusInternalServerErrorConcept{})
		return
	}
...
func addDeviceProfile(dp models.DeviceProfile, dbClient interfaces.DBClient, w http.ResponseWriter) {
	...
	if err != nil {
		HttpErrorHandler.Handle(w, err, []httperror.ErrorConceptType{httperror.DeviceProfileContractInvalidErrorConcept{}, httperror.DeviceProfileBadRequestErrorConcept{}, httperror.DuplicateIdentifierErrorConcept{}, httperror.DeviceProfileEmptyNameErrorConcept{}}, httperror.StatusInternalServerErrorConcept{})
		return
	}
